...
class CmsPageTest < ActiveSupport::TestCase
  ...
  def test_fixtures_validity
    Occams::Cms::Translation.all.each do |translation|
      assert translation.valid?, translation.errors.full_messages.to_s
    end
  end

  def test_validations
    translation = Occams::Cms::Translation.new
    translation.save
  ...
  def test_creation
    translation_count = -> { Occams::Cms::Translation.count }
  ...
  def test_scope_published
    assert_equal 1, Occams::Cms::Translation.published.count
    @translation.update_columns(is_published: false)
    assert_equal 0, Occams::Cms::Translation.published.count
  end
