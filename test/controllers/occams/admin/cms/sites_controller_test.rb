...
class Occams::Admin::Cms::SitesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_get_new
    r :get, new_occams_admin_cms_site_path
    assert_response :success
    assert assigns(:site)
  ...
  def test_get_edit
    ...
    r :get, edit_occams_admin_cms_site_path(id: site)
    assert_response :success
    assert assigns(:site)
  ...
  def test_get_edit_failure
    r :get, edit_occams_admin_cms_site_path(id: 'invalid')
    assert_response :redirect
  ...
  def test_create
    assert_difference 'Occams::Cms::Site.count' do
      ...
      assert_redirected_to occams_admin_cms_site_layouts_path(site_id: site)
      assert_equal 'Site created', flash[:success]
    end
  end

  def test_creation_failure
    assert_no_difference 'Occams::Cms::Site.count' do
      r :post, occams_admin_cms_sites_path, params: { site: {} }
      assert_response :success
      assert_template :new
  ...
  def test_destroy
    assert_difference 'Occams::Cms::Site.count', -1 do
      r :delete, occams_admin_cms_site_path(id: occams_cms_sites(:default))
      assert_response :redirect
      assert_redirected_to action: :index
