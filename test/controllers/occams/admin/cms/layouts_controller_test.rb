...
class Occams::Admin::Cms::LayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_get_index
    ...
    r :get, occams_admin_cms_site_layouts_path(site_id: @site)
  ...
  def test_get_new
    r :get, new_occams_admin_cms_site_layout_path(site_id: @site)
    assert_response :success
  ...
  def test_get_new_with_parent
    ...
    r :get, new_occams_admin_cms_site_layout_path(site_id: @site), params: { parent_id: layout.id }
    assert_response :success
  ...
  def test_get_edit
    layout = occams_cms_layouts(:default)
    r :get, edit_occams_admin_cms_site_layout_path(site_id: @site, id: layout)
    assert_response :success
    assert assigns(:layout)
  ...
  def test_get_edit_failure
    r :get, edit_occams_admin_cms_site_layout_path(site_id: @site, id: "invalid")
    assert_response :redirect
  ...
  def test_creation_failure
    assert_no_difference "Occams::Cms::Layout.count" do
      r :post, occams_admin_cms_site_layouts_path(site_id: @site), params: { layout: {} }
      assert_response :success
      assert_template :new
  ...
  def test_destroy
    assert_difference "Occams::Cms::Layout.count", -1 do
      r :delete, occams_admin_cms_site_layout_path(site_id: @site, id: occams_cms_layouts(:default))
      assert_response :redirect
      assert_redirected_to action: :index
  ...
  def test_reorder
    ...
    r :put, reorder_occams_admin_cms_site_layouts_path(site_id: @site), params: {
