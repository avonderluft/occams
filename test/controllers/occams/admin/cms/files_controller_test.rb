...
class Occams::Admin::Cms::FilesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_get_index_with_category
    ...
    r :get, occams_admin_cms_site_files_path(site_id: @site), params: {
  ...
  def test_get_new
    r :get, new_occams_admin_cms_site_file_path(site_id: @site)
    assert_response :success
    assert assigns(:file)
    assert_template :new
  ...
  def test_get_edit
    r :get, edit_occams_admin_cms_site_file_path(site_id: @site, id: @file)
    assert_response :success
    assert assigns(:file)
  ...
  def test_get_edit_failure
    r :get, edit_occams_admin_cms_site_file_path(site_id: @site, id: "invalid")
  ...
  def test_create
    ...
    assert_difference [file_count, categorization_count, attachment_count] do
      ...
      assert_response :redirect
      file = Occams::Cms::File.last
      assert_equal occams_cms_sites(:default), file.site
  ...
  def test_create_as_plupload
    ...
    assert_difference [file_count, attachment_count] do
      ...
      assert_select "li[data-id='#{Occams::Cms::File.last.id}']"
    end
  end
  ...
  def test_create_as_redactor
    ...
    assert_difference [file_count, categorization_count, attachment_count] do
      ...
      category = Occams::Cms::Category.last
  ...
  def test_destroy
    ...
    assert_difference([file_count, attachment_count], -1) do
      r :delete, occams_admin_cms_site_file_path(site_id: @site, id: @file)
      assert_response :redirect
      assert_redirected_to action: :index
  ...
  def test_destroy_as_xhr
    assert_difference(-> { Occams::Cms::File.count }, -1) do
      r :delete, occams_admin_cms_site_file_path(site_id: @site, id: @file), xhr: true
      assert_response :success
    end
  end
  ...
  def test_reorder
    ...
    r :put, reorder_occams_admin_cms_site_files_path(site_id: @site), params: {
