...
class Occams::Admin::Cms::PagesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_get_index
    r :get, occams_admin_cms_site_pages_path(site_id: @site)
  ...
  def test_get_index_with_category
    ...
    r :get, occams_admin_cms_site_pages_path(site_id: @site), params: { categories: category.label }
    assert_response :success
    assert assigns(:pages)
  ...
  def test_get_index_with_category_invalid
    r :get, occams_admin_cms_site_pages_path(site_id: @site), params: { categories: 'invalid' }
    assert_response :success
    assert assigns(:pages)
  ...
  def test_get_links_with_redactor
    r :get, occams_admin_cms_site_pages_path(site_id: @site), params: { source: 'redactor' }
    assert_response :success
  ...
  def test_get_new
    r :get, new_occams_admin_cms_site_page_path(site_id: @site)
    assert_response :success
    assert assigns(:page)
  ...
  def test_get_new_as_child_page
    r :get, new_occams_admin_cms_site_page_path(site_id: @site), params: { parent_id: @page }
    assert_response :success
    assert assigns(:page)
    assert_equal occams_cms_pages(:default), assigns(:page).parent
    assert_template :new
  end

  def test_get_edit
    r :get, edit_occams_admin_cms_site_page_path(site_id: @site, id: @page)
    assert_response :success
    assert assigns(:page)
  ...
  def test_get_edit_failure
    r :get, edit_occams_admin_cms_site_page_path(site_id: @site, id: 'not_found')
    assert_response :redirect
  ...
  def test_creation_with_files
    assert_difference 'Occams::Cms::Page.count' do
      assert_difference 'Occams::Cms::Fragment.count', 3 do
  ...
  def test_creation_failure
    assert_no_difference ['Occams::Cms::Page.count', 'Occams::Cms::Fragment.count'] do
      r :post, occams_admin_cms_site_pages_path(site_id: @site), params: { page: {
        layout_id: @layout.id,
        fragments_attributes: [
          { identifier: 'content',
            content: 'content content' },
  ...
  def test_update
    assert_no_difference 'Occams::Cms::Fragment.count' do
  ...
  def test_get_form_fragments
    r :get, form_fragments_occams_admin_cms_site_page_path(site_id: @site, id: @page), xhr: true, params: {
      layout_id: occams_cms_layouts(:nested).id
    }
    assert_response :success
    assert assigns(:page)
  ...
  def test_get_form_fragments_for_new_page
    r :get, form_fragments_occams_admin_cms_site_page_path(site_id: @site, id: 0), xhr: true, params: {
      layout_id: @layout.id
    }
    assert_response :success
    assert assigns(:page)
  ...
  def test_update_preview
    assert_no_difference 'Occams::Cms::Page.count' do
      r :put, occams_admin_cms_site_page_path(site_id: @site, id: @page), params: {
        preview: 'Preview',
        page: {
          label: 'Updated Label',
          fragments_attributes: [
  ...
  def test_get_new_with_no_layout
    ...
    r :get, new_occams_admin_cms_site_page_path(site_id: @site)
    assert_response :redirect
    assert_redirected_to new_occams_admin_cms_site_layout_path(@site)
  ...
  def test_reorder
    ...
    r :put, reorder_occams_admin_cms_site_pages_path(site_id: @site), params: {
