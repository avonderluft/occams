...
class Occams::Admin::Cms::SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_get_index
    ...
    r :get, occams_admin_cms_site_snippets_path(site_id: @site)
  ...
  def test_get_index_with_category
    ...
    r :get, occams_admin_cms_site_snippets_path(site_id: @site), params: { categories: category.label }
    assert_response :success
    assert assigns(:snippets)
  ...
  def test_get_index_with_category_invalid
    r :get, occams_admin_cms_site_snippets_path(site_id: @site), params: { categories: 'invalid' }
    assert_response :success
    assert assigns(:snippets)
  ...
  def test_get_new
    r :get, new_occams_admin_cms_site_snippet_path(site_id: @site)
    assert_response :success
  ...
  def test_get_edit
    r :get, edit_occams_admin_cms_site_snippet_path(site_id: @site, id: @snippet)
    assert_response :success
    assert assigns(:snippet)
  ...
  def test_get_edit_with_params
    r :get, edit_occams_admin_cms_site_snippet_path(site_id: @site, id: @snippet), params: { snippet: {
      label: 'New Label'
    } }
    assert_response :success
    assert assigns(:snippet)
  ...
  def test_get_edit_failure
    r :get, edit_occams_admin_cms_site_snippet_path(site_id: @site, id: 'invalid')
    assert_response :redirect
  ...
  def test_destroy
    assert_difference 'Occams::Cms::Snippet.count', -1 do
      r :delete, occams_admin_cms_site_snippet_path(site_id: @site, id: @snippet)
      assert_response :redirect
      assert_redirected_to action: :index
