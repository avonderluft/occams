...
Occams.configure do |config|
  ...
  # Controller that Occams::Cms::BaseController will inherit from
  #   config.public_base_controller = 'ApplicationController'

  # Module responsible for authentication. You can replace it with your own.
  # It simply needs to have #authenticate method. See http_auth.rb for reference.
  #   config.admin_auth = 'OccamsAdminAuthentication'
  ...
  #   config.admin_authorization = 'OccamsAdminAuthorization'

  # Module responsible for public authentication. Similar to the above. You also
  # will have access to @cms_site, @cms_layout, @cms_page so you can use them in
  # your logic. Default module doesn't do anything.
  #   config.public_auth = 'OccamsPublicAuthentication'

  # Module responsible for public authorization. It should have #authorize
  # method that returns true or false based on params and loaded instance
  # variables available for a given controller.
  #   config.public_authorization = 'OccamsPublicAuthorization'
...
# module OccamsAdminAuthorization
#   def authorize
#     return true
#   end
# end
...
# module OccamsPublicAuthentication
#   def authenticate
#     return true
#   end
# end
...
# module OccamsPublicAuthorization
#   def authorize
#     return true
#   end
# end
